...
def get_urls():
	"""
	Return a list of urls by reading the txt file supplied as arguments in terminal
	"""
	try:
		url_input = sys.argv[1]
	except IndexError:
		print('ERROR: Please provide the txt file\n Example \n\n$python downloader.py dogs.txt \n\n')
		sys.exit()
...
def run_downloader(process:int, images_urls:list):
	"""
	Inputs:
	process: (int) numbers of process to run
